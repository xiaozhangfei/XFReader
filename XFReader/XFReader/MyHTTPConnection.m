...
- (NSObject<HTTPResponse> *)httpResponseForMethod:(NSString *)method URI:(NSString *)path
{
    ...
    if ([method isEqualToString:@"POST"] && [path isEqualToString:@"/upload.html"])
    {
        ...
        [filesStr appendString:@"<table>"];
        for( NSString* filePath in uploadedFiles ) {
            //generate links
            [filesStr appendString:@"<tr><td  class='trs'>"];
            [filesStr appendString:[filePath lastPathComponent]];
            [filesStr appendString:@"</td><td  class='trs'><img src='received.png' class='imgIcon'/></td></tr>"];
        }
        [filesStr appendString:@"</table>"];
        ...
        [replacementDict setValue:filesStr forKey:@"MyFiles"];
...
//        }
        ...
        for (NSString *ul in upA) {
            ...
            [st appendString:ul];
            [st appendString:@"</td><td  class='trs'><img src='close.png' class='imgIcon'/></td></tr>"];
        }
        [st appendString:@"</table>"];
